...
# Solution based on https://www.globalnerdy.com/2020/12/06/my-solution-to-advent-of-code-2020s-day-4-challenge-in-python/
# Used to debug my own code after failing to build failing test cases manually
...
# Debug my code
for passport in truly_valid_passports:
    print(passport['pid'])
